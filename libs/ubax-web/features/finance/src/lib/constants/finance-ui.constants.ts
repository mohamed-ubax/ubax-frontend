import type {
  ...
  FinanceOverdueSidebarItem,
  FinanceOverdueRow,
  FinanceExpenseLegendItem,
  FinanceRevenuePoint,
  FinanceTenantProfile,
  FinanceTenantPaymentState,
  FinanceTenantInfoCard,
  FinanceTenantDocument,
  FinanceTenantPayment,
