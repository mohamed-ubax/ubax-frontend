...
export class DashboardComptablePageComponent {
  ...
  readonly revenueData = {
    ...
    datasets: [
      {
        data: [
          1200000, 1800000, 2100000, 1600000, 2800000, 2200000, 3500000,
          2900000, 2400000, 3100000, 2700000, 3800000,
        ],
        borderColor: '#e87d1e',
  ...
  readonly overduePayments = [
    {
      ...
      property: 'Villa Riviera — Cocody',
      daysLate: 12,
    },
    {
      name: 'Kouamé Patrick',
      property: 'Immeuble Kalia — Plateau',
      daysLate: 8,
    },
    {
      name: 'Touré Mamadou',
      property: 'Maison Yopougon — Yopougon',
      daysLate: 5,
    },
    {
      name: 'Bamba Seydou',
      property: 'Appt. Deux Plateaux — 2 Plx',
      daysLate: 18,
    },
    {
      name: 'Diomandé Fatou',
      property: 'Studio Marcory — Marcory',
      daysLate: 3,
    },
