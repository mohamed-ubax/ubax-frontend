import type {
  LocataireDocument,
  LocataireInfoItem,
  LocatairePaymentItem,
} from '../types/locataire-detail.types';

const ASSET_ROOT = 'reservations/locataire-detail';

export const LOCATAIRE_DETAIL_ASSETS = {
...
export const CONTACT_ITEMS: readonly LocataireInfoItem[] = [
  {
...
export const STATUS_ITEMS: readonly LocataireInfoItem[] = [
  {
...
export const CONTRACT_ITEMS: readonly LocataireInfoItem[] = [
  {
...
export const LOCATAIRE_DOCUMENTS: readonly LocataireDocument[] = [
...
export const PAYMENT_HISTORY: readonly LocatairePaymentItem[] = [
  {
