...
export function list6(http: HttpClient, rootUrl: string, params?: List6$Params, context?: HttpContext): Observable<StrictHttpResponse<HotelResponse>> {
