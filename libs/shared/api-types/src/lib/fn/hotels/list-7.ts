...
export function list7(http: HttpClient, rootUrl: string, params?: List7$Params, context?: HttpContext): Observable<StrictHttpResponse<HotelResponse>> {
