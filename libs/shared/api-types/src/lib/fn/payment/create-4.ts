...
export function create4(http: HttpClient, rootUrl: string, params: Create4$Params, context?: HttpContext): Observable<StrictHttpResponse<PaymentResponse>> {
