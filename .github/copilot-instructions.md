...
Ce fichier complete AGENTS.md et sert de point d'entree pour GitHub Copilot.
Le miroir racine `CLAUDE.md` doit rester synchronise avec ce document afin que Claude et Copilot recoivent les memes instructions de travail.
